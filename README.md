...
📚 Core CS Subjects:<br>
Data Structures and Algorithms (max rating: 1840 on LeetCode), Object-Oriented Programming (OOPs), Operating Systems (OS), Database Management Systems (DBMS), Machine Learning (ML), System Design <br>
💻 My Tech Stack: <br>
...
<!--
**Aakanksha13-cloud/Aakanksha13-cloud** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
